...
function EffectPass( renderer, is20, hasShaderTextureLOD, callback, obj, forceMuted, forcePaused, outputGainNode, copyProgram, id, effect  )
{
    this.mID = id;
...
Effect.prototype.saveScreenshot = function(filename, passid)
{
    ...
    if( pass.mType == "buffer" )
    {
        ...
        piTriggerDownload(filename, blob);
    }
...
Effect.prototype.Paint = function(time, dtime, fps, mouseOriX, mouseOriY, mousePosX, mousePosY, isPaused)
{
    ...
    if( this.mFrame==0 )
    {
        ...
        for( var i=0; i<this.mMaxCubeBuffers; i++ )
        {
